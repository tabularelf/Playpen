...
*/
#macro PLAYPEN_DEFAULT_FILESYSTEM_GM_BEHAVIOUR true
...
/*
	...
	- cache_directory
 	...
 	Note: This does not apply to PLAYPEN_DEFAULT_FILESYSTEM_GM_BEHAVIOUR, and will need to be disabled for full on
 	control over the whitelist system.
*/
#macro PLAYPEN_DEFAULT_WHITELIST_INCLUDED true